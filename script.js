...
const translations = {
  en: {
    ...
    guideTitle: "This page is the front door to DD's AI work.",
    guideOneTitle: "Understand the whole picture",
    guideOneText: "Start with the cards to see the kind of products DD builds with AI.",
    ...
    quickOneTitle: "1. See what DD can build",
  ...
  ja: {
    ...
    guideTitle: "このページは、DDのAI作品を見る入口です。",
